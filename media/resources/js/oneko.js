/*
 * AUTHOR: adryd325, toydotgame
 * CREATED: 2022-04-20
 * oneko.js: https://github.com/adryd325/oneko.js
 * toydotgame modifications add a `title` attr, and replace the reduce motion
 * UA detection with a double-click-to-zap mechanism instead.
 */
...
(function oneko() {
	...
	function init() {
		...
		if (persistPosition) {
			...
			if (storedNeko !== null) {
				if(Date.now()-storedNeko.explodedAt < 3600000) return;
		...
		nekoEl.id = "oneko";
		nekoEl.title = "Double click to hide me for an hour! Miaw!";
